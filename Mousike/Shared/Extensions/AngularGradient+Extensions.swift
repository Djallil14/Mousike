...
extension AngularGradient {
    ...
    static let purpleGradient = AngularGradient(colors: [.purple, .secondaryBackground, .blue, .purple], center: .zero)
    static let blueGradient = AngularGradient(colors: [.accentColor], center: .zero)
